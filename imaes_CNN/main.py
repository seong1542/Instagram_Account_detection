...
def evaluate(model, test_loader,valid_loss_min):
    ...
    return val_loss, val_acc, valid_loss_min
...
def main(args):
    ...
    if args.mode == 'train':
        ...
        for epoch in range(args.epoch):
            ...
            # validate set
            val_loss, val_acc, valid_loss_min = evaluate(model, val_dataloader,valid_loss_min)
        ...
        model.load_state_dict(torch.load('resnet18_test.pt', map_location=device))
        model = model.to(DEVICE)
